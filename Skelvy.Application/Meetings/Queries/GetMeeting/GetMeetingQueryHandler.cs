...
{
  public class GetMeetingQueryHandler : IRequestHandler<GetMeetingQuery, MeetingViewModel>
  {
    private readonly SkelvyContext _context;
    private readonly IMapper _mapper;

    public GetMeetingQueryHandler(SkelvyContext context, IMapper mapper)
    {
      _context = context;
      _mapper = mapper;
    }

    public async Task<MeetingViewModel> Handle(GetMeetingQuery request, CancellationToken cancellationToken)
    {
