...
{
  public class ReverseLocationsQueryHandler : QueryHandler<ReverseLocationsQuery, IList<Location>>
  {
    ...
    public override async Task<IList<Location>> Handle(ReverseLocationsQuery request)
    {
