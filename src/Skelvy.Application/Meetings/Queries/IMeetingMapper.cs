...
namespace Skelvy.Application.Meetings.Queries
{
  ...
  {
    Task<SelfModel> Map(User user, Meeting meeting, IList<MeetingChatMessage> messages, MeetingRequest meetingRequest, string language);
    Task<SelfModel> Map(User user, MeetingRequest meetingRequest, string language);
    SelfModel Map(User user);
    Task<MeetingModel> Map(Meeting meeting, IList<MeetingChatMessage> messages, MeetingRequest meetingRequest, string language);
