...
{
  public class UpdateMeetingRequestCommandValidator : AbstractValidator<UpdateMeetingRequestCommand>
  {
    public UpdateMeetingRequestCommandValidator()
    {
      ...
      RuleForEach(x => x.Activities).SetValidator(new UpdateMeetingRequestActivityValidator());
    }
  }

  public class UpdateMeetingRequestActivityValidator : AbstractValidator<UpdateMeetingRequestActivity>
  {
    public UpdateMeetingRequestActivityValidator()
    {
