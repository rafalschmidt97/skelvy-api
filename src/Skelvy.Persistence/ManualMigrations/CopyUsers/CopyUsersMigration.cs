...
namespace Skelvy.Persistence.ManualMigrations.CopyUsers
{
  public class CopyUsersMigration : IMigration
  {
    private const string FromConnectionString = "SKELVY_SQL_CONNECTION";
    private const string ToConnectionString = "SKELVY_SQL_CONNECTION";

    public async Task Migrate()
    {
      var fromConnection = new SqlConnection(FromConnectionString);
      var toConnection = new SqlConnection(ToConnectionString);
