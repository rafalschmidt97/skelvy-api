...
namespace Skelvy.Application.Test.Meetings.Commands
{
  public class UpdateMeetingCommandHandlerTest : RequestTestBase
  {
    ...
    {
      var request = new UpdateMeetingCommand(2, 1, DateTimeOffset.UtcNow, 1, 1, 1, false, false);
    ...
    {
      var request = new UpdateMeetingCommand(100, 1, DateTimeOffset.UtcNow, 1, 1, 1, false, false);
      var dbContext = InitializedDbContext();
      var handler = new UpdateMeetingCommandHandler(
        new MeetingsRepository(dbContext),
        new GroupUsersRepository(dbContext),
    ...
    {
      var request = new UpdateMeetingCommand(2, 100, DateTimeOffset.UtcNow, 1, 1, 1, false, false);
      var dbContext = InitializedDbContext();
      var handler = new UpdateMeetingCommandHandler(
        new MeetingsRepository(dbContext),
        new GroupUsersRepository(dbContext),
    ...
    {
      var request = new UpdateMeetingCommand(2, 1, DateTimeOffset.UtcNow, 1, 1, 100, false, false);
      var dbContext = InitializedDbContext();
      var handler = new UpdateMeetingCommandHandler(
        new MeetingsRepository(dbContext),
        new GroupUsersRepository(dbContext),
